        ...
        <form method="post" name="create_extension" action="<?php current_url(); ?>">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sname" id="cod" value="<?php echo $post_1['surname']; ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" id="user" value="<?php echo $post_2[0]->username; ?>" class="form-control">
                    <?php echo form_error('username')
                    ?>
                </div>
                <div class="form-group">
                    <label for="cod">Admin's Password</label>
                    <input type="password" name="pass" id="cod" value="<?php echo $this->encryption->decrypt($post_2[0]->password); ?>" class="form-control">
                    <?php echo form_error('pass')
                    ?>
                </div>
                <div class="form-group">
                    <label for="secr">Admin's Secret Word</label>
                    <input type="text" name="secret" id="secr" value="<?php echo $this->encryption->decrypt($post_2[0]->secretWord); ?>" class="form-control">
