<div class="main-header">
  ...
  <div class="logo-header" data-background-color="blue">
    ...
    <a href="<?php echo base_url() ?>" class="logo">
      <img src="<?php echo base_url() ?>assets/img/logo.jpeg" alt="navbar brand" style="width:40px" ; class="navbar-brand">
    </a>
        ...
        <li class="nav-item dropdown hidden-caret">
          ...
          <ul class="dropdown-menu dropdown-user animated fadeIn">
            <div class="dropdown-user-scroll scrollbar-outer">
              <li>
                <div class="user-box">
                  <div class="avatar-lg"><img src="<?php echo base_url() ?>assets/img/techub.jpeg" alt="image profile" class="avatar-img rounded"></div>
                  <div class="u-text">
                    <h4>Hizrian</h4>
              ...
              <li>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo base_url('auth2/logout') ?>">Logout</a>
              </li>
            </div>
          </ul>
        </li>
